...
## Model Output 
The model output directory contains the aggregated extracted feature vectors and cluster order files:

### Aggregated extracted feature vectors: are used as input to predict consumption levels at a cluster.
### Cluster order: is simply the order of the clusters during the feature vector prediction.
